...
public:
	...
	void render(string strKey, HDC hdc, int destX, int destY, int destWidth, int destHight);
	//이미지클리핑 (잘라그리기)
	...
	//=====루프랜드=====
	void camRender(string strKey, HDC hdc, const LPRECT drawArea, int offsetX, int offsetY);
